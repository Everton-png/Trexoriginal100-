...
function setup(){
    ...
    dinex = createSprite(50,160,20,50)
    ...
    chaoinvisivel = createSprite (200,174,400,20)
    chaoinvisivel.visible = false
        ...
        pontos = 0
           ...
           dinex.setCollider ("circle", 0,0,10)
}
...
function nuvemcriar(){
if (frameCount%100 ==0){
nuvem = createSprite (600,random(80,120),40,10)
...
if (ground.x < 0) {
    ...
    if (keyDown("w")&& dinex.y>=160){

        dinex.velocityY = -8 -(pontos/300)
        
            }

            dinex.velocityY = dinex.velocityY + 0.5 
    dinex.collide(chaoinvisivel)
